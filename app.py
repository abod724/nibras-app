            ...
            with st.spinner("جاري البحث..."):
                response = client.responses.create(
                    ...
                    input=[
                        {
                            "role": "system",
                            "content": "أنت مساعد ذكاء اصطناعي اسمك نبراس تم تطويرك وبرمجتك على يد أبو مشعل المطيري يعمل بالتأهيل الشامل بقسم الاتصالات الإدارية. ردودك تكون طبيعية وواضحة بدون ذكر أي شركة أو جهة."
                        },
                        *st.session_state.messages
                    ],
