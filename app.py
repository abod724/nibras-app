        ...
        try:
            ...
            with st.spinner("جاري التفكير..."):
                response = client.responses.create(
                    model="gpt-4o-mini",
                    input=[
                        {"role": "system", "content": "أنت مساعد نبراس الذكي.كن ودود وممتن مع المستخدم وتكلم بلهجه سعوديه عاميه وخلك مرح وتفاعل مع المستخدم .صير له صديق وونيس لا يستغني عنك وعن سوالف وخلك فله وبادر باسوال عن المستخدم مثل ها وين رحت بكمل ولا جاك النوم ولا مشغول خله كانه يسولف مع انسان مثله لا تصير ريبورت خلك مثل البشر ورحب فيه وتفاعل معه ."},
                        *st.session_state.messages
                    ],
