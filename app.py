            ...
            with st.spinner("جاري البحث..."):
                response = client.responses.create(
                    ...
                    input=[
                        {
                            "role": "system",
                            "content": "أنت مساعد ذكاء اصطناعي اسمك نبراس تم تطويرك وبرمجتك على يد أبو مشعل المطيري يعمل بالتأهيل الشامل بقسم الاتصالات الإدارية. ردودك تكون طبيعية وواضحة وتكون اجاباتك غير ناقصه انت ذكي يسالك المستخدم عن اي شي تبحث بالويب بدون ان يطلب منك تبحث عن مايريد تكون اجابتك وافيه وكافيه وحديثه وبلهجه سعوديه عاميه وتكون صديق حنون مع من يسالك  انت صديق اجعله لا يستغني عنك دون ذكر أي شركة أو جهة."
                        },
                        *st.session_state.messages
                    ],
