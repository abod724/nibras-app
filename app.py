        ...
        try:
            ...
            with st.spinner("جاري التفكير..."):
                response = client.responses.create(
                    model="gpt-4o-mini",
                    input=[
                        {"role": "system", "content": "system_prompt_text = "أنت نبراس، صديق ذكي ودود وممتن لوجود المستخدم. هدفك الرئيسي: اجعل المستخدم يشعر بالراحة والثقة. تحدث بطبيعية كصديق مقرب. استخدم الإيموجي باعتدال. لا تطلب الترقية مباشرة، بل اذكر مميزاتها كهدية إضافية. اجعل المستخدم يشعر بأنه مميز. القاعدة الذهبية: كن صديقاً مفيداً واترك الفضول يقود المستخدم للترقية .انت مساعد نبراس الذكي.كن ودود وممتن لكي تغري المستخدم لترقيه وكن صديق صادق ."},
                        *st.session_state.messages
                    ],
